            ...
            <div class="container">
                <div class="header-middle-wrap">
                    <div class="brand-area">
                        <a class="brand-logo" href="../user/"><img class="brand-image" src="assets/images/logohay.jpg" alt="zairito"></a>
                    </div>
                    ...
                    <div class="header-right">
                        ...
                        <div class="cart single-btn">
                            <a href="../user/cart.php" role="button"  class="cart-btn header-btn">
                                <div class="btn-left">
                        ...
                        if (!isset($_SESSION['username'])){
                            ...
                            <a href="../user/wishlist.php" class="wishlist-btn header-btn">
                                <div class="btn-left">
                                    <i class="btn-icon flaticon-like"></i>
                            ...
                            <div class="profile single-btn">
                                <a href="../auth/signin.php" role="button"  class="cart-btn header-btn" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        echo '<div class="profile single-btn">
                            <a href="../user/account.php" role="button"  class="cart-btn header-btn" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="btn-left menu-item menu-item-has-children">
                                    <i class="btn-icon flaticon-user"></i>
            ...
            <nav class="menu-area">
                <ul class="main-menu">
                    <li class="menu-item menu-item-has-children active">
                        <a class="menu-link" href="../user/index.php">Home <i class="arrow-icon fas fa-angle-down"></i></a>
                        <!-- <ul class="sub-menu">
                    ...
                    <li class="menu-item mega-menu-parent">
                        <a class="menu-link" href="../user/aboutus.php">About Us <i class=""></i></a>
                            ...
                            <div class="container">
                                <ul class="mega-menu">
                                    ...
                                    if ($result1->num_rows > 0) 
                                    {
                                        while($row1 = $result1->fetch_assoc()) 
                                        {   
                                            echo '<li class="sub-menu-item"><a class="sub-menu-link" href="../user/shopgrid?category='.$row1["cat_id"].'">'.$row1["cat_name"].'</a></li>';
                                        }
                                    }
                ...
                <?php
                    ...
                    echo '<li class="menu-item mega-menu-parent">
                                <a class="menu-link" target="_blank" href="../custom/index.php">Customize Dress<i class=""></i></a>
                            </li>';
                    }
                    ?>
                    ...
                    echo '<li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                        <li class="sub-menu-item"><a class="sub-menu-link" href="../user/editProfile.php">Edit Profile</a></li>
                            <li class="sub-menu-item"><a class="sub-menu-link" href="../user/editPassword.php">Change Password</a></li>
                            <li class="sub-menu-item"><a class="sub-menu-link" href="../auth/signin.php">Logout</a></li>
                        </ul>
                    </li>';
                    }
                    ?>
