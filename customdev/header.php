                ...
                <div class="header-middle-wrap">
                    ...
                    <div class="header-right">
                        ...
                        <div class="cart single-btn">
                            <a href="http://localhost/lol_frontend/cart.php" role="button"  class="cart-btn header-btn">
                                <div class="btn-left">
                        ...
                        if (!isset($_SESSION['username'])){
                            echo '
                            <div class="http://localhost/lol_frontend/wishlist single-btn">
                            <a href="http://localhost/lol_frontend/wishlist.php" class="wishlist-btn header-btn">
                                <div class="btn-left">
                                    <i class="btn-icon flaticon-like"></i>
            ...
            <nav class="menu-area">
                <ul class="main-menu">
                    <li class="menu-item menu-item-has-children active">
                        <a class="menu-link" href="http://localhost/lol_frontend/index.php">Home <i class="arrow-icon fas fa-angle-down"></i></a>
                        <!-- <ul class="sub-menu">
                    ...
                    <li class="menu-item mega-menu-parent">
                        <a class="menu-link" href="http://localhost/lol_frontend/aboutus.php">About Us <i class=""></i></a>
                            ...
                            <div class="container">
                                <ul class="mega-menu">
                                    ...
                                    if ($result1->num_rows > 0) 
                                    {
                                        while($row1 = $result1->fetch_assoc()) 
                                        {   
                                            echo '<li class="sub-menu-item"><a class="sub-menu-link" href="http://localhost/lol_frontend/shopgrid?category='.$row1["cat_id"].'">'.$row1["cat_name"].'</a></li>';
                                        }
                                    }
                ...
                <?php
                    ...
                    echo '<li class="menu-item menu-item-has-children">
                        ...
                        <li class="sub-menu-item"><a class="sub-menu-link" href="http://localhost/lol_frontend/editProfile.php">Edit Profile</a></li>
                            <li class="sub-menu-item"><a class="sub-menu-link" href="http://localhost/lol_frontend/editPassword.php">Change Password</a></li>
