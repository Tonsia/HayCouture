                                ...
                                <div id='lol3' class="product-thumbnail-image">
                                    ...
                                    $result1=$conn->query("SELECT * FROM color_details where product_id='$pid'");
                                                if ($result1->num_rows > 0) 
                                                {
                                                    ...
                                                    echo '<li id="'.$row1['color_id'].'" class="single-item"><img class="single-item-image" src="http://localhost/proadmin/'.$i1.'" alt="product"></li>';
                                                    echo '<li class="single-item"><img class="single-item-image" src="http://localhost/proadmin/'.$i2.'" alt="product"></li>';
