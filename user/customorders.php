                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    <div class="product-image">
                                                        <a href="./productpage?productid='.$rowc['uniqueid'].'"><img class="product-thumbnal" src="./assets/custom-order.jpg" alt="product"></a>
                                                    </div>
                                                </td>
                                                <td>
                                    ...
                                    if ($qry0->num_rows > 0) 
                                    {
                                        ...
                                        while($row0 = $qry0->fetch_assoc()) 
                                        {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    <div class="product-image">
                                                        <a href="./productpage?productid='.$productid.'"><img class="product-thumbnal" src="../admin/assets/uploaded_files/product_images/HCP2531_1.webp" alt="product"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-info text-center">
