                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div  class="product-single-left">
                                <div id='lol3' class="product-thumbnail-image">
                                    <ul id='lol1' class="product-thumb-silide slider slider-nav">
                                    ...
                                    $color1='';
                                    $pid = $_GET["productid"];
                                    $result1=$conn->query("SELECT * FROM color_details where product_id='$pid'");
                                                if ($result1->num_rows > 0) 
                                                {
                                                    ...
                                                    echo '<li id="'.$row1['color_id'].'" class="single-item"><img class="single-item-image" src="../admin/'.$i1.'" alt="product"></li>';
                                                    echo '<li class="single-item"><img class="single-item-image" src="../admin/'.$i2.'" alt="product"></li>';
                                ...
                                <div class="product-slier-big-image">
                                    <div id='lol2' class="product-priview-slide slider slider-for">
                                        ...
                                        $result1=$conn->query("SELECT * FROM color_details where product_id='$pid'");
                                                    if ($result1->num_rows > 0) 
                                                    {
                                                        ...
                                                        echo '<div class="single-slide">
                                                                    <img class="slide-image" src="../admin/'.$i1.'" alt="product">
                                                                </div>';

                                                        echo '<div class="single-slide">
                                                            <img class="slide-image" src="../admin/'.$i2.'" alt="product">
                                                        </div>';
                        ...
                        <?php   
                                    $pid = $_GET["productid"];
                                    $result1=$conn->query("SELECT * FROM products where product_id='$pid'");
                                    $row1='';
                                    if ($result1->num_rows > 0) 
                                    { 
                        ...
                        <div class="col-lg-6">
                            <div class="product-single-right">
                                <div class="product-info">
                                    ...
                                    <h3 class="product-name"> <?php echo $row1['p_name']  ?> </h3>
                                    ...
                                    <div class="product-price">
                                        <?php
                                            if($row1['product_discount']!=0 ){
                                                echo '<span class="regular-price">₹'.$row1['product_price'].'</span>';
                                            }
                                        ?>
                                        <span class="price">₹<?php echo $row1['product_total']?></span>
                                    </div>

                                    <p class="note-text"><?php echo $row1['product_desc']?></p>
                                    
                                    <div class="product-color-area">
                                        <h4 id='colorname' class="color-title">COLOR</h4>
                                        <div class="variable-single-item color-switch">
                                            <div class="product-variable-color">
                                                <?php
                                                    $pid = $_GET["productid"];
                                                    $result1=$conn->query("SELECT product_color.color,product_color.color_code,color_details.color_id FROM product_color INNER JOIN color_details ON product_color.color_id = color_details.color_id WHERE color_details.product_id='$pid';");
                                                    if ($result1->num_rows > 0) 
                                                    {
                                                        while($row1 = $result1->fetch_assoc()) 
                                                        {
                                                            echo '<label>
                                                                        <input id="colorradio" data-id="'.$row1["color_id"].'" name="modal-product-color" data-color="'.$row1["color"].'" class="color-select" type="radio" onclick="fnfn(this)" data-toggle="popover" data-content="hiii">
                                                                        <span class="" style="background: '.$row1["color_code"].'"></span>
                                                                    </label>';
                                                        }
                                                    }
                                                ?>
                                    ...
                                    <div class="product-size-area">
                                        ...
                                        <ul class="size-switch">
                                            <?php
                                                $pid = $_GET["productid"];
                                                $result1=$conn->query("SELECT product_size.size, product_size.size_id FROM product_size INNER JOIN size_details ON product_size.size_id = size_details.size_id WHERE size_details.product_id='$pid';");
                                                if ($result1->num_rows > 0) 
                                                {
                                                    while($row1 = $result1->fetch_assoc()) 
                                                    {
                                                        echo '<li data-sizeid="'.$row1['size_id'].'" class="single-size">'.$row1['size'].'</li>';
                                                    }
                                                }
                                            ?>
                                        </ul>
                                    ...
                                    <div id='plusminusbtn' class="prdouct-btn-wrapper d-flex align-items-center">
                                        <div  class="cart-plus-minus">
                                            <div class="dec qtybutton btn">-</div>
                                            <input id='qty' class="cart-plus-minus-box" type="number" name="qtybutton" value="1" readonly="">
                                    ...
                                    <div id='buybutton' class="product-bottom-button d-flex">
                                        <a onclick="addcart(this)" class="primary-btn">Buy Now</a>
                                        <button  onclick="addcart(this)" title="Add to cart" class="add-cart">Add To Cart <i class="icon fas fa-plus-circle"></i></button>
                                    </div>
                                </div>
                                <div class="product-right-bottom">
                                    <ul class="features">
                                        <li class="single-feature"><img class="icon" src="assets/images/delivery-van-icon.svg" alt="icon"><strong class="feature-title">Estimated Delivery:<span class="feature-text" id="enddate"> Within 10-15 days</span></li>
                                        <li class="single-feature"><img class="icon" src="assets/images/shipping-return.svg" alt="icon"><strong class="feature-title">Free Shipping & Returns:</strong><span class="feature-text">On all orders over 750</span></li>
                                    </ul>
                    ...
                    <div class="tab-content" id="ProductTabContent">
                        ...
                        <div class="tab-pane fade " id="Description" role="tabpanel" aria-labelledby="Description-tab">
                            <div class="product-description">
                                ...
                                <?php
                                    $pid = $_GET["productid"];
                                    $result1=$conn->query("SELECT * from category where cat_id = (SELECT cat_id from products where product_id = '$pid')");
                                    if ($result1->num_rows > 0) 
                                    {
                                        while($row1 = $result1->fetch_assoc()) 
                                        {
                        ...
                        <?php
                            $pid = $_GET["productid"];
                            $result2=$conn->query("SELECT * from review where productid='$pid' and review_status=1");
                            $result3=$conn->query("SELECT AVG(ratingscore) AS avgscore FROM review where productid='$pid' and review_status=1");$row3=$result3->fetch_array();
                            $avgrating = $row3['avgscore'];
                            ...
                            <div class="product-reviews">
                                <div class="review-top">
                                    <div class="review-top-left">
                                        <span class="review-point"><?php echo number_format((float)$avgrating, 1, '.', ''); ?></span>
                                        <ul class="review-list">
                                            <?php 
                                                if($result2->num_rows > 0){
                                                    for($i=0;$i<5;$i++){
                                                        if($i<floor($avgrating)){
                                                            echo '<li class="review-item active"><i class="flaticon-star"></i></li>';
                                                        }else{
                                                            echo '<li class="review-item"><i class="flaticon-star"></i></li>';
                                                        }
                                                    }
                                                }
                                            ?>
                                        </ul>
                                        <span class="review-count"><?php echo $result2->num_rows ?> reviews</span>
                                    </div>
                                    <div class="review-top-right">
                                        <a href="myorders.php" class="write-review-btn">Write A Review</a>
                                    </div>
                                </div>
                                ...
                                <?php 
                                    if ($result2->num_rows > 0) 
                                    {
                                        while($row2 = $result2->fetch_assoc()) 
                                        {
                                            $str='';
                                            for($i=0;$i<5;$i++){
                                                if($i<$row2['ratingscore']){
                                                    $str .='<li class="review-item active"><i class="flaticon-star"></i></li>';
                                                }else{
                                                    $str .= '<li class="review-item"><i class="flaticon-star"></i></li>';
                                                }
                                            }

                                            $regid= $row2['userid'];

                                            $result4=$conn->query("SELECT reg_name FROM registration where reg_id='$regid'");$row4=$result4->fetch_array();

                                            echo '<div class="single-review">
                                                    <div class="reviewer">
                                                        <div class="reviewer-wrap">
                                                            <h4 class="reviewer-name p-5">'.$row4['reg_name'].'</h4>
                                                        </div>
                                                    </div>
                                                    <div class="review-middle">
                                                        ...
                                                        <span class="remiew-time">'.$row2['ratingscore'].' rating  </span>
                                                    </div>
                                                    <h3 class="review-title">'.$row2['title'].'</h3>
                                                    <h4 class="review-meta"><span class="time">'.$row2['created'].'</span></h4>
                                                    <p class="review-text">'.$row2['ratingdesc'].'</p>
                                                </div>';
                                        }
                                    }
                                    else{
...
$(document).ready(function() {
    ...
    $(".single-size").click(function(){
        ...
        $.ajax({
            url: 'ajax.php?action=outofstock',
            type: 'post',
            data: {
                productid : <?php echo "'".$_GET['productid']."'" ?>,
                sizeid : $(".single-size.active").data('sizeid')
            },
            success: function(response){
                if(response==2){
                    //alert("No");
                    $('#buybutton').html('<a class="primary-btn">Out of Stock</a>')
                    $('#plusminusbtn').html('')
    ...
    $(".qtybutton").click(function(){
        ...
        if($(".single-size.active").data('sizeid')===undefined){
            $("#qty").val(1);
            Swal.fire({
                    icon: 'error',
                    title: 'Select the product size....'
        ...
        $.ajax({
            url: 'ajax.php?action=stockcheck',
            type: 'post',
            data: {
                productid : <?php echo "'".$_GET['productid']."'" ?>,
                qty : $("#qty").val(),
            ...
            success: function(response){
                if(response==2){
                    ...
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Only '+qtval+' Products Remaining...',
                    })
        ...
        function addcart(e){
            ...
            console.log($(".single-size.active").data('sizeid'))
            console.log($('input[type=radio][name=modal-product-color]:checked').data('id'))
            ...
            $.ajax({
                ...
                data: { 
                    ...
                    quantity : $("#qty").val(),
                    size: $(".single-size.active").data('sizeid'),
                    color: $('input[type=radio][name=modal-product-color]:checked').data('id')
                },
                //cache: false,
