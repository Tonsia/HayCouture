                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    // custom order
                                    $qryc = $conn->query("SELECT * FROM customorder WHERE userid = '$userid' and paymentid != 'Pending' ORDER BY created desc");
                                    if ($qryc->num_rows > 0) 
                                    {
                                        $i=1;
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    <div class="product-image">
                                                        <a><img class="product-thumbnal" src="./assets/custom-order.jpg" alt="product"></a>
                                                    </div>
                                                </td>
                                                <td>
                                    ...
                                    // regular order
                                    $qry0 = $conn->query("SELECT * FROM orders WHERE userid = '$userid' AND status = '1' ORDER BY createdtime desc");
                                    if ($qry0->num_rows > 0) 
                                    {
                                        //$i=1;
                                        while($row0 = $qry0->fetch_assoc()) 
                                        {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    <div class="product-image">
                                                        <a href="./productpage?productid='.$productid.'"><img class="product-thumbnal" src="../admin/'.$row5["img1"].'" alt="product"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-info text-center">
                                                ...
                                                <td>
                                                    <div class="product-price text-center">
                                                        <h3 class="price">₹'.$row0['totalamt'].'</h3>
                                                    </div>
                                                </td>
