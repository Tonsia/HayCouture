                        ...
                        <div class="col-lg-6">
                            <div  class="product-single-left">
                                <div id='lol3' class="product-thumbnail-image">
                                    ...
                                    //for cart details
                                    $cartid = $_GET["cartid"];
                                    $cartresult=$conn->query("SELECT * FROM cart where id='$cartid'");
                            ...
                            <div class="product-single-right">
                                <div class="product-info">
                                    ...
                                    <div class="product-bottom-button d-flex">
                                        ...
                                        <button class="primary-btn" onclick="updatecart(this)" title="Add to cart" class="add-cart">Update Cart <i class="icon fas fa-plus-circle"></i></button>
                                    </div>
                                </div>
...
var cid = '<?php echo $cartrow["color_id"] ?>'; 
var sid = '<?php echo $cartrow["size_id"] ?>';
var qty = '<?php echo $cartrow["quantity"] ?>';                                    
...
$(document).ready(function() {
        ...
        document.querySelector("[data-sizeid='"+sid+"']").click();
        ...
        function updatecart(e){
            ...
            $.ajax({
                url: "ajax.php?action=updatecart", 
                type: "POST",
                data: { 
                    productid : <?php echo "'".$_GET['productid']."'" ?> ,
